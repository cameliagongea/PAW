    ...
    <div class="row">
        <div class="box">
            <div class="col-lg-12 text-center">
                <div id="carousel-example-generic" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive img-full" src="../../../public/Photos/main.jpg">
                        </div>
                        <div class="item">
                            <img class="img-responsive img-full" src="../../../public/Photos/starter.jpg">
                        </div>
                        <div class="item">
                            <img class="img-responsive img-full" src="../../../public/Photos/desert.jpg">
                        </div>
                    </div>
                ...
                <h1 class="brand-name">I Was There</h1>
